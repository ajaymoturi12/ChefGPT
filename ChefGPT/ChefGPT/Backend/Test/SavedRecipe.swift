...
class SavedRecipe: ObservableObject {
    ...
    static let sampleData = [
        SavedRecipe(id: 716429, name: "Peanut Butter Jelly", foodImage: "https://spoonacular.com/recipeImages/673463-312x231.jpg", time: 5, vegetarian: true, vegan: false, glutenFree: false, dairyFree: true, preparationMinutes: 4, cookingMinutes: 5, ingredients: [
        ExtendedIngredients(name: "Peanut Butter", amount: 2, unit: "oz"),
        ExtendedIngredients(name: "Jelly", amount: 2, unit: "oz"),
        ExtendedIngredients(name: "Bread", amount: 2, unit: "slices")
        ], instructions: instructions),
        SavedRecipe(id: 716428, name: "Peanut Butter Jelly", foodImage: "https://spoonacular.com/recipeImages/673463-312x231.jpg", time: 5, vegetarian: true, vegan: false, glutenFree: false, dairyFree: false, preparationMinutes: 5, cookingMinutes: 5, ingredients: [
        ExtendedIngredients(name: "Peanut Butter", amount: 2, unit: "oz"),
        ExtendedIngredients(name: "Jelly", amount: 2, unit: "oz"),
        ExtendedIngredients(name: "Bread", amount: 2, unit: "slices")
        ], instructions: instructions),
        SavedRecipe(id: 716426, name: "Peanut Butter Jelly", foodImage: "https://spoonacular.com/recipeImages/673463-312x231.jpg", time: 5, vegetarian: false, vegan: false, glutenFree: false, dairyFree: true, preparationMinutes: 6, cookingMinutes: 5, ingredients: [
        ExtendedIngredients(name: "Peanut Butter", amount: 2, unit: "oz"),
        ExtendedIngredients(name: "Jelly", amount: 2, unit: "oz"),
        ExtendedIngredients(name: "Bread", amount: 2, unit: "slices")
        ], instructions: instructions)
